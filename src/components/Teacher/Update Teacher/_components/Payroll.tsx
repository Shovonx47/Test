...
const PayrollInformation = ({ control, setValue, trigger, singleTeacher }: PersonalInfoProps) => {
    return (
                ...
                <div className="m-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    <div>
                        ...
                        <Controller
                            name="EPFNo"
                            control={control}
                            defaultValue={singleTeacher?.data?.EPFNo || ""}
                            render={({ field }) => (
                    ...
                    {[
                        { name: "basicSalary", label: "Basic Salary", defaultValue: singleTeacher?.data?.basicSalary || "" },
                        { name: "workLocation", label: "Work Location", defaultValue: singleTeacher?.data?.workLocation || "" },
                    ...
                    <Controller
                        name="contractType"
                        control={control}
                        defaultValue={singleTeacher?.data?.contractType || ""}
                    ...
                    <Controller
                        name="workShift"
                        control={control}
                        defaultValue={singleTeacher?.data?.workShift || ""}
