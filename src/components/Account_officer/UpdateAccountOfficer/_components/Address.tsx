...
interface AddressInfoProps {
    ...
    singleAccountOfficer: AddressProps
}

const Address = ({ control, singleAccountOfficer }: AddressInfoProps) => {
    return (
                ...
                <div className="m-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <Controller
                            name="presentAddress"
                            control={control}
                            defaultValue={singleAccountOfficer?.data?.presentAddress}
                    ...
                    <div>
                        ...
                        <Controller
                            ...
                            control={control}
                            defaultValue={singleAccountOfficer?.data?.permanentAddress}
