...
interface PersonalInfoProps {
    ...
    singleAccountOfficer: ParentsAndGuardianFormValues
}

const ParentsAndGuardianInformation = ({ control, setValue, trigger, singleAccountOfficer }: PersonalInfoProps) => {
            ...
            <div className="border rounded-md">
                ...
                <div className="m-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    {[
                        ...
                        <div key={name}>
                            ...
                            <Controller
                                name={name}
                                control={control}
                                defaultValue={singleAccountOfficer?.data?.[name] || ""}
                    ...
                    <Controller
                        ...
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.fatherOccupation}
                ...
                <div className="m-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    ...
                    <Controller
                        ...
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.motherOccupation}
