...
interface TransportInfoProps {
    ...
    singleAccountOfficer: TransportProps
}

const TransportInformation = ({ control, setValue, watch, trigger, singleAccountOfficer }: TransportInfoProps) => {
                ...
                {isTransportEnabled && (
                    <div className="m-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <Controller
                            name="route"
                            control={control}
                            defaultValue={singleAccountOfficer?.data?.route || ""}
                        ...
                        <Controller
                            name="vehicleNumber"
                            control={control}
                            defaultValue={singleAccountOfficer?.data?.vehicleNumber || ""}
                        ...
                        <Controller
                            name="pickupPoint"
                            control={control}
                            defaultValue={singleAccountOfficer?.data?.pickupPoint || ""}
