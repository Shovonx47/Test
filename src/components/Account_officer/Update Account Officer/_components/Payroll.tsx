...
const PayrollInformation = ({ control, setValue, trigger, singleAccountOfficer }: PersonalInfoProps) => {
    return (
                ...
                <div className="m-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    <div>
                        ...
                        <Controller
                            name="EPFNo"
                            control={control}
                            defaultValue={singleAccountOfficer?.data?.EPFNo || ""}
                            render={({ field }) => (
                    ...
                    {[
                        { name: "basicSalary", label: "Basic Salary", defaultValue: singleAccountOfficer?.data?.basicSalary || "" },
                        { name: "workLocation", label: "Work Location", defaultValue: singleAccountOfficer?.data?.workLocation || "" },
                    ...
                    <Controller
                        name="contractType"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.contractType || ""}
                    ...
                    <Controller
                        name="workShift"
                        control={control}
                        defaultValue={singleAccountOfficer?.data?.workShift || ""}
