...
interface PersonalInfoProps {
    ...
    singleAccountOfficer: { data: { experiences: ExperienceProps[] } }
}

const Experiences = ({ control, setValue, trigger, watch, getValues, singleAccountOfficer }: PersonalInfoProps) => {
    ...
    useEffect(() => {
        if (hasExperience) {
            if (fields.length === 0) {
                replace(singleAccountOfficer?.data?.experiences || [{ organizationName: "", startDate: "", endDate: "", designation: "", address: "" }]);
            }
        } else {
    ...
    console.log(singleAccountOfficer)
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 w-full">
                                    <div>
                                        ...
                                        <Controller
                                            ...
                                            control={control}
                                            defaultValue={singleAccountOfficer?.data?.experiences?.[index]?.organizationName || ""}
                                    ...
                                    <Controller
                                        name={`experiences.${index}.startDate`}
                                        control={control}
                                        defaultValue={singleAccountOfficer?.data?.experiences?.[index]?.startDate || ""}
                                        rules={{
                                    ...
                                    <Controller
                                        ...
                                        control={control}
                                        defaultValue={singleAccountOfficer?.data?.experiences?.[index]?.endDate || ""}
                                        rules={{
                                    ...
                                    <div>
                                        ...
                                        <Controller
                                            ...
                                            control={control}
                                            defaultValue={singleAccountOfficer?.data?.experiences?.[index]?.designation || ""}
                                    ...
                                    <div>
                                        ...
                                        <Controller
                                            ...
                                            control={control}
                                            defaultValue={singleAccountOfficer?.data?.experiences?.[index]?.address || ""}
