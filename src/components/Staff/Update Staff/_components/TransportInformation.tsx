...
interface TransportInfoProps {
    ...
    singleStaff: TransportProps
}

const TransportInformation = ({ control, setValue, watch, trigger, singleStaff }: TransportInfoProps) => {
                ...
                {isTransportEnabled && (
                    <div className="m-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <Controller
                            name="route"
                            control={control}
                            defaultValue={singleStaff?.data?.route || ""}
                        ...
                        <Controller
                            name="vehicleNumber"
                            control={control}
                            defaultValue={singleStaff?.data?.vehicleNumber || ""}
                        ...
                        <Controller
                            name="pickupPoint"
                            control={control}
                            defaultValue={singleStaff?.data?.pickupPoint || ""}
