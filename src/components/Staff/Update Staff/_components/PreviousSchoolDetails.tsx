...
interface PreviousSchoolInfoProps {
    ...
    singleStaff: PreviousSchoolProps
}
...
const PreviousSchoolDetails = ({ control, setValue, watch, trigger, singleStaff }: PreviousSchoolInfoProps) => {
    const isPreviousSchool = watch("previousSchool", singleStaff?.data?.previousSchool) === true;
            ...
            <div className="border rounded-md">
                <div className="p-4 bg-[#E9EDF4] rounded-md rounded-b-none flex justify-between items-center gap-2 mb-5">
                    ...
                    <Controller
                        name="previousSchool"
                        control={control}
                        defaultValue={singleStaff?.data?.previousSchool}
                        render={({ field }) => (
                            <Switch
                    ...
                    <div className="m-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <Controller
                                ...
                                control={control}
                                defaultValue={singleStaff?.data?.previousSchoolName || ""}
                        ...
                        <div>
                            <Controller
                                ...
                                control={control}
                                defaultValue={singleStaff?.data?.previousSchoolPosition || ""}
                        ...
                        <div>
                            ...
                            <Controller
                                ...
                                control={control}
                                defaultValue={singleStaff?.data?.previousSchoolRating || ""}
                                render={({ field }) => (
                                    <div>
                                        <Input
                                            {...field}
                        ...
                        <div>
                            ...
                            <Controller
                                ...
                                control={control}
                                defaultValue={singleStaff?.data?.previousSchoolAddress || ""}
