...
interface AddressInfoProps {
    ...
    singleStaff: AddressProps
}

const Address = ({ control, singleStaff }: AddressInfoProps) => {
    return (
                ...
                <div className="m-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <Controller
                            name="presentAddress"
                            control={control}
                            defaultValue={singleStaff?.data?.presentAddress}
                    ...
                    <div>
                        ...
                        <Controller
                            ...
                            control={control}
                            defaultValue={singleStaff?.data?.permanentAddress}
