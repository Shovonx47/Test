...
interface HostelInfoProps {
    ...
    singleStaff: HostelProps
}

const HostelInformation = ({ control, setValue, watch, trigger, singleStaff }: HostelInfoProps) => {
                ...
                {isHostelEnabled && (
                    <div className="m-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Controller
                            name="hostelName"
                            control={control}
                            defaultValue={singleStaff?.data?.hostelName || ""}
                        ...
                        <Controller
                            name="roomNumber"
                            control={control}
                            defaultValue={singleStaff?.data?.roomNumber || ""}
